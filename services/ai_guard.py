...
def amounts_in(text: str) -> set[int]:
    ...
    позицій під одну валюту й суми словами. Розширити це можна лише ціною
    хибних спрацювань на вагах і тривалостях, яких у блоці даних повно, а вони
    б'ють по єдиному сигналу адмінам про зламаний запобіжник.
    """
